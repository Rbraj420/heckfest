        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <a className="nav-link active" aria-current="page" href="#">Service Polict</a>
              </li>
            </ul>
          </div>
        </div>
            ...
            <div className="row gy-4 gy-lg-0 justify-content-xl-between">
              ...
              <div className="col-12 col-md-4 col-lg-3 col-xl-2">
                <div className="widget">
                  ...
                  <address className="mb-4">Indian Institute of Technology (Indian School of Mines), Dhanbad</address>
                  <p className="mb-1">
                    <a className="link-secondary text-decoration-none" href="tel:+919177653425">+919177653425</a>
                  </p>
                  <p className="mb-0">
                    <a className="link-secondary text-decoration-none" href="mailto:demo@yourdomain.com">predictticket@gmail.com</a>
                  </p>
                </div>
              </div>
              <div className="col-12 col-md-4 col-lg-3 col-xl-2">
            ...
            <div className="row gy-4 gy-md-0 align-items-md-center">
              <div className="col-xs-12 col-md-7 order-1 order-md-0">
                ...
                <div className="credits text-secondary text-center text-md-start mt-2 fs-8">
                  Built by <a href="https://bootstrapbrain.com/" className="link-secondary text-decoration-none">Mission-Ticket</a> with <span className="text-primary">&#9829;</span>
                </div>
              </div>
